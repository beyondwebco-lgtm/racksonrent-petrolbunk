...
export const SHOWCASE_CATEGORIES: ShowcaseCategory[] = [
  ...
  },
  {
    id: "ev-charging",
    eyebrow: "Category 05",
    title: "EV Charging Lounge Shelf",
    shortName: "EV Lounge",
    description:
      "A dedicated display rack set up in EV charging zones or lounges, perfect for tech gadgets, magazines, and premium refreshments.",
    suitableFor: [
      "Tech gadgets & cables",
    ...
    benefits: [
      "Captive audience during charging",
      "High dwell time for customers",
      "Appeals to premium segment",
      "Boosts lounge experience",
      "Excellent branding opportunity",
    ],
    primaryCta: "List EV Lounge Space",
    secondaryCta: "Find Space in EV Lounge",
    image: "/showcase/showcase-5.jpeg",
    iconName: "Zap",
    rolePrimary: "bunk-owner",
    spaceTypePrimary: "EV Charging Lounge Shelf",
    roleSecondary: "brand-merchant",
    categorySecondary: "Tech & Accessories",
  },
  {
    id: "emergency-spares",
    eyebrow: "Category 06",
    title: "Emergency Spares & Tools Rack",
    shortName: "Emergency Spares",
    description:
      "Essential toolkit replacements, puncture kits, fuses, and minor spare parts available 24/7 for highway emergencies.",
    suitableFor: [
      "Tubeless puncture kits",
      "Basic toolkit sets",
      "Automotive fuses & bulbs",
      "Jumper cables",
      "Tow ropes & straps",
      "Engine oil top-ups",
    ],
    benefits: [
      "Crucial for highway pumps",
      "High urgency purchases",
      "Builds customer goodwill",
      "24/7 availability",
      "Steady demand",
    ],
    primaryCta: "List Spares Space",
    secondaryCta: "Find Space for Auto Spares",
    image: "/showcase/showcase-6.jpeg",
    iconName: "Stethoscope",
    rolePrimary: "bunk-owner",
    spaceTypePrimary: "Forecourt Canopy Display Rack",
    roleSecondary: "brand-merchant",
    categorySecondary: "Emergency Auto Spares",
  }
];
