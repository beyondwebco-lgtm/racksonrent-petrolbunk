  ...
  return (
    <div className="bg-[#FFFDF5] min-h-screen pt-8 sm:pt-14 pb-20">
          ...
          <div className="text-center max-w-3xl mx-auto mb-10">
            ...
            <div className="flex justify-center mb-3">
              <span className="inline-flex items-center gap-1.5 rounded-full bg-[#6B0F1A] px-4 py-1 text-xs font-extrabold text-[#FFFBCC]">
                <Sparkles className="w-3.5 h-3.5 text-[#FAFA33]" /> Step-by-Step Retail Partnership
              </span>
            </div>
        ...
        <ScrollReveal delayMs={150}>
          <div className="relative max-w-3xl mx-auto rounded-3xl overflow-hidden shadow-xl border-2 border-[#F0E2E4] bg-white group">
            <div className="relative aspect-[16/9] max-h-[340px] sm:max-h-[380px] w-full overflow-hidden">
              ...
              <div className="absolute bottom-4 right-4 sm:right-6 bg-[#6B0F1A] text-[#FFFBCC] px-3.5 py-1.5 rounded-xl border border-[#FAFA33]/40 shadow-md flex items-center gap-2">
        ...
        <ScrollReveal>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {featureCards.map((card, idx) => (
              <div 
                key={idx} 
                className="bg-white p-5 rounded-2xl border border-[#F0E2E4] shadow-2xs hover:shadow-md hover:border-[#FAFA33]/60 transition-all duration-300"
              >
        ...
        <ScrollReveal delayMs={100}>
          <div className="bg-white rounded-3xl border-2 border-[#F0E2E4] p-4 sm:p-8 shadow-xl relative overflow-hidden group">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-between gap-4 mb-6 pb-4 border-b border-[#F0E2E4]">
              <div>
                <span className="inline-flex items-center gap-1.5 text-xs font-extrabold uppercase tracking-widest text-[#6B0F1A] bg-[#FFFBCC] px-3.5 py-1 rounded-full border border-[#FAFA33]/40 mb-1.5">
              ...
              <div className="flex items-center gap-2">
                <button
                  ...
                  className="inline-flex items-center gap-1.5 px-4 py-2 rounded-xl bg-[#FFFBCC] text-[#3D0710] border border-[#FAFA33] text-xs font-extrabold hover:bg-[#FAFA33] transition-all cursor-pointer shadow-xs"
                >
            ...
            >
              ...
              <div className="absolute inset-0 bg-black/0 group-hover/img:bg-black/10 transition-colors flex items-center justify-center pointer-events-none">
                <span className="opacity-0 group-hover/img:opacity-100 transition-opacity bg-[#3D0710] text-[#FFFBCC] border border-[#FAFA33] px-5 py-2.5 rounded-full text-xs font-extrabold shadow-2xl flex items-center gap-2">
      ...
      <section className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <ScrollReveal>
          <div className="bg-gradient-to-br from-[#6B0F1A] via-[#3D0710] to-[#6B0F1A] rounded-[2.5rem] p-8 sm:p-14 text-center shadow-2xl relative overflow-hidden border-2 border-[#FAFA33]/30">
            ...
            <div className="relative z-10">
              <span className="inline-flex items-center gap-1.5 rounded-full bg-[#FAFA33] px-4 py-1 text-xs font-extrabold text-[#3D0710] mb-4">
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-4">
                <Link
                  href="/#contact"
                  className="w-full sm:w-auto inline-flex items-center justify-center gap-2 rounded-2xl bg-[#FAFA33] px-7 py-3.5 text-sm sm:text-base font-black text-[#3D0710] shadow-lg hover:bg-white hover:-translate-y-0.5 transition-all duration-300"
                >
        ...
        <div className="fixed inset-0 z-50 bg-black/90 backdrop-blur-md flex items-center justify-center p-2 sm:p-6 animate-fade-in">
          ...
          <div className="absolute top-4 right-4 sm:top-6 sm:right-6 z-50 flex items-center gap-3">
            <a
              href={activeTab === "bunk-owner" ? "/images/how-it-works-owners.jpg" : "/images/how-it-works-entrepreneurs.jpg"}
              download={activeTab === "bunk-owner" ? "RacksOnRent_Owners_Infographic.jpg" : "RacksOnRent_Entrepreneurs_Infographic.jpg"}
              className="inline-flex items-center gap-1.5 px-4 py-2 rounded-full bg-[#FAFA33] text-[#3D0710] text-xs font-black hover:bg-white transition shadow-lg"
            >
              Download High Res
            </a>
            <button
