      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 text-center divide-y sm:divide-y-0 sm:divide-x divide-[#520a13]">
          {statsList.map((stat) => (
            ...
            >
              <div className="p-2.5 rounded-2xl bg-[#6B0F1A] mb-1 group-hover:bg-[#3D0710] border border-[#520a13] group-hover:border-[#F7E200]/30 transition-colors">
                {stat.icon}
              </div>
              <span className="font-archivo text-3xl sm:text-4xl font-black text-[#F7E200] tracking-tight">
                <AnimatedCounter
