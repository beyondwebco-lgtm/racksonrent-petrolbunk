      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between gap-4">
        ...
        >
          ...
          <div className="flex flex-col justify-center">
            ...
            <div className="flex items-baseline font-black tracking-tighter leading-none text-xl sm:text-2xl lg:text-3xl">
              ...
              <span className="text-[#FFF100] font-bold italic lowercase mx-1 text-[0.8em]" style={{ fontFamily: "Georgia, serif" }}>on</span>
              <span className="text-[#FFF100] font-black italic">Rent</span>
            </div>
            ...
            <div className="flex items-center gap-1 mt-0.5 text-[8px] sm:text-[9px] lg:text-[10px] font-black uppercase tracking-[0.18em] leading-none whitespace-nowrap">
              ...
              <span className="text-[#FFF100]">SHARE SUCCESS.</span>
              <span className="h-[1.5px] w-3 bg-[#6B0F1A] inline-block" />
            </div>
          </div>
        </Link>
        ...
        <nav className="hidden lg:flex items-center gap-0.5 xl:gap-1.5">
          {NAV_LINKS.map((link) => (
            <Link
              ...
              className="nav-link-hover px-2.5 xl:px-3.5 py-2 rounded-xl text-xs xl:text-sm font-bold text-[#1F1F1F] hover:text-[#6B0F1A] hover:bg-[#FFFBCC]/60 transition-colors whitespace-nowrap"
            >
              {link.label}
            </Link>
          ))}
        ...
        <div className="flex items-center gap-2 lg:hidden">
          <button
            type="button"
            onClick={handleListYourSpace}
            className="inline-flex items-center gap-1 px-3 py-2 rounded-full bg-[#FFF100] text-[#3D0710] border border-[#E6D900] text-xs font-extrabold shadow-xs cursor-pointer"
          >
        ...
        >
          ...
          <div className="p-6 border-t border-[#F0E2E4] bg-[#FFFBCC]/30">
            <button
              type="button"
              onClick={handleListYourSpace}
              className="w-full inline-flex items-center justify-center gap-2 rounded-full bg-[#FFF100] py-3.5 text-base font-extrabold text-[#3D0710] border border-[#E6D900] shadow-xs cursor-pointer"
            >
