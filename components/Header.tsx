      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-2 lg:hidden">
          <button
            type="button"
            onClick={handleListYourSpace}
            className="inline-flex items-center gap-1 px-3 py-2 rounded-full bg-[#F7E200] text-[#3D0710] border border-[#D9C800] text-xs font-extrabold shadow-xs cursor-pointer"
          >
        ...
        >
          ...
          <div className="p-6 border-t border-[#F0E2E4] bg-[#FFFBCC]/30">
            <button
              type="button"
              onClick={handleListYourSpace}
              className="w-full inline-flex items-center justify-center gap-2 rounded-full bg-[#F7E200] py-3.5 text-base font-extrabold text-[#3D0710] border border-[#D9C800] shadow-xs cursor-pointer"
            >
