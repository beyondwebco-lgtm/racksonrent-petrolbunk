...
export default function PopularCategories() {
  ...
  return (
    <section className="py-16 sm:py-24 bg-[#F8FAFC] overflow-hidden" id="products">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="relative group/carousel px-2 sm:px-4">
          ...
          <button
            ...
            className={`absolute -left-2 sm:left-0 top-1/2 -translate-y-1/2 z-20 w-11 h-11 rounded-full bg-[#0B1E36] text-[#FEF9C3] border-2 border-[#F4E409] flex items-center justify-center shadow-lg transition-all cursor-pointer ${
              !canScrollLeft
                ? "opacity-30 cursor-not-allowed pointer-events-none"
                : "hover:bg-[#061221] hover:text-[#F4E409] hover:scale-105"
            }`}
          >
          ...
          <button
            ...
            className={`absolute -right-2 sm:right-0 top-1/2 -translate-y-1/2 z-20 w-11 h-11 rounded-full bg-[#0B1E36] text-[#FEF9C3] border-2 border-[#F4E409] flex items-center justify-center shadow-lg transition-all cursor-pointer ${
              !canScrollRight
                ? "opacity-30 cursor-not-allowed pointer-events-none"
                : "hover:bg-[#061221] hover:text-[#F4E409] hover:scale-105"
            }`}
            ...
            {POPULAR_CATEGORIES.map((cat: CategoryItem) => {
              return (
                <button
                  ...
                  className="category-card flex-shrink-0 w-[82vw] max-w-[280px] sm:w-[calc(50%-10px)] md:w-[calc(33.333%-14px)] lg:w-[calc(25%-15px)] snap-start text-left rounded-3xl border border-[#E2E8F0] bg-white p-5 shadow-[0_8px_25px_rgba(11,30,54,0.05)] hover:shadow-[0_16px_40px_rgba(11,30,54,0.12)] hover:border-[#0B1E36]/40 transition-all hover:-translate-y-1 flex flex-col justify-between group cursor-pointer relative overflow-hidden h-full min-h-[340px]"
                >
                  {cat.badge && (
                    <span className="absolute top-7 right-7 text-[10px] font-extrabold bg-[#F4E409] text-[#061221] px-2.5 py-1 rounded-full border border-[#0B1E36]/20 z-10 shadow-xs">
                      {cat.badge}
                    </span>
                  )}
                  ...
                  <div>
                    ...
                    <div className="relative w-full aspect-square rounded-2xl bg-[#F8FAFC] border border-[#E2E8F0] overflow-hidden p-3 mb-4 flex items-center justify-center group-hover:border-[#0B1E36]/30 transition-colors">
                      <Image
                        src={cat.image}
                        alt={cat.alt}
                        fill
                    ...
                    <h3 className="font-extrabold text-base text-[#0B1E36] group-hover:text-[#061221] transition-colors mb-1.5 leading-snug">
                      {cat.name}
                    </h3>
                  ...
                  <div className="mt-4 pt-3 border-t border-[#E2E8F0] flex items-center justify-between text-xs font-extrabold text-[#0B1E36] group-hover:text-[#061221]">
