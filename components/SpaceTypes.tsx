            ...
            {COMPACT_SPACE_TYPES.map((item) => (
              ...
              >
                ...
                <div className="absolute inset-0 p-5 sm:p-6 flex flex-col justify-end z-10 text-white">
                  <div>
                    <h3 className="font-extrabold text-lg sm:text-xl text-white mb-2 group-hover:text-[#FAFA33] transition-colors">
                      {item.name}
                    </h3>
                  ...
                  <div className="flex items-center text-xs sm:text-sm font-bold text-[#FAFA33] group-hover:text-white transition-colors">
