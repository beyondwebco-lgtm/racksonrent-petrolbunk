    ...
    <section className="section-padding bg-[#FFFDF5] border-y border-[#F0E2E4] overflow-hidden" id="space-types">
      <div className="container-main">
        ...
        >
          ...
          <button 
            onClick={handlePrev}
            className="absolute left-0 top-1/2 -translate-y-1/2 -translate-x-4 sm:-translate-x-6 z-10 p-2.5 sm:p-3 rounded-full bg-[#6B0F1A] border-2 border-[#FDFF00] text-white shadow-lg hover:bg-[#FDFF00] hover:text-[#3D0710] hover:border-[#E6D900] transition-colors focus:outline-none focus:ring-2 focus:ring-[#FDFF00]"
          ...
          <button 
            onClick={handleNext}
            className="absolute right-0 top-1/2 -translate-y-1/2 translate-x-4 sm:translate-x-6 z-10 p-2.5 sm:p-3 rounded-full bg-[#6B0F1A] border-2 border-[#FDFF00] text-white shadow-lg hover:bg-[#FDFF00] hover:text-[#3D0710] hover:border-[#E6D900] transition-colors focus:outline-none focus:ring-2 focus:ring-[#FDFF00]"
            ...
            {COMPACT_SPACE_TYPES.map((item) => (
              ...
              >
                ...
                <div className="absolute inset-0 p-5 sm:p-6 flex flex-col justify-end z-10 text-white">
                  <div>
                    <h3 className="font-extrabold text-lg sm:text-xl text-white mb-2 group-hover:text-[#FDFF00] transition-colors">
                      {item.name}
                    </h3>
                  ...
                  <div className="flex items-center text-xs sm:text-sm font-bold text-[#FDFF00] group-hover:text-white transition-colors">
