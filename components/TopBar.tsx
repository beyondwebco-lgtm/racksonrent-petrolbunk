      ...
      <div className="max-w-7xl mx-auto flex flex-wrap items-center justify-between gap-2 sm:gap-4">
        ...
        <div className="flex items-center gap-4 ml-auto sm:ml-0">
          <a
            ...
            className="flex items-center gap-1 text-white/80 hover:text-[#FAFA33] transition-colors"
          >
            <Phone className="w-3.5 h-3.5 text-[#FAFA33]" />
            <span>{SITE_CONFIG.phoneFormatted}</span>
          </a>

          <a
            href={SITE_CONFIG.mailtoLink}
            className="hidden sm:flex items-center gap-1 text-white/80 hover:text-[#FAFA33] transition-colors"
          >
            <Mail className="w-3.5 h-3.5 text-[#FAFA33]" />
            <span>{SITE_CONFIG.email}</span>
          </a>

          <a
            href={SITE_CONFIG.mailtoSecondaryLink}
            className="hidden lg:flex items-center gap-1 text-white/80 hover:text-[#FAFA33] transition-colors"
          >
            <Mail className="w-3.5 h-3.5 text-[#FAFA33]" />
