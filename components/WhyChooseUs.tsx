                ...
                <div>
                  ...
                  <div className="flex items-center justify-between mb-4">
                    <div
                      className={`flex h-12 w-12 items-center justify-center rounded-xl transition-all duration-300 flex-shrink-0 ${
                        isMaroon
                          ? "bg-[#F7E200] text-[#3D0710] border border-[#D9C800] group-hover:bg-white group-hover:scale-105"
                  ...
                  <h3
                    className={`card-title font-black transition-colors ${
                      isMaroon ? "text-white group-hover:text-[#F7E200]" : "text-[#3D0710] group-hover:text-[#6B0F1A]"
                    }`}
                  >
                    {item.title}
                  </h3>
