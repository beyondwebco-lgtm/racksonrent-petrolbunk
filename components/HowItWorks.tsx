    ...
    <section className="section-padding bg-[#3D0710] overflow-hidden" id="how-it-works">
      <div className="container-main">
        ...
        <div className="relative rounded-3xl border border-[#520a13] bg-[#6B0F1A] shadow-xl overflow-hidden group p-6 sm:p-10 text-center animate-reveal-up">
          ...
          <div className="absolute bottom-0 left-0 w-48 h-48 bg-[#F7E200]/5 rounded-full blur-2xl translate-y-1/3 -translate-x-1/4"></div>

          <div className="relative z-10 flex flex-col items-center">
            <div className="flex gap-3 mb-4">
              <div className="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center text-[#F7E200]">
                <Zap className="w-5 h-5" />
              </div>
              <div className="w-10 h-10 rounded-full bg-[#F7E200]/20 flex items-center justify-center text-[#F7E200]">
