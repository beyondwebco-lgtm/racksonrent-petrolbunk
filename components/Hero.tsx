...
export default function Hero({ onSelectRole }: HeroProps) {
  ...
  return (
    <section className="relative py-3 lg:py-5 xl:py-6 bg-[radial-gradient(circle_at_80%_20%,rgba(11,30,54,0.06),transparent_40%),linear-gradient(180deg,#FFFDF5_0%,#FFF6A3_50%,#FFFDF5_100%)] border-b border-[#F0E2E4]" id="hero">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-5 lg:gap-6 items-center">
          ...
          <div className="lg:col-span-6 space-y-2.5 sm:space-y-3">
            ...
            <h1 className="text-xl sm:text-2xl lg:text-3xl xl:text-4xl font-extrabold tracking-tight text-[#6B0F1A] leading-[1.12]">
              Turn Unused Petrol Pump Space{" "}
              <span className="bg-[#F4E409] text-[#3D0710] px-2 py-0.5 rounded-lg inline-block mt-0.5 border border-[#6B0F1A]/20">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-1.5 pt-0.5">
              {benefitItems.map((item, idx) => (
                <div key={idx} className="flex items-center gap-1.5 bg-white/90 backdrop-blur-xs px-2 py-1 rounded-lg border border-[#F0E2E4] shadow-2xs">
                  <div className="p-0.5 rounded-md bg-[#FFF6A3] flex-shrink-0">
                    {React.cloneElement(item.icon, { className: "w-3.5 h-3.5 text-[#6B0F1A]" })}
                  </div>
            ...
            <div className="relative pt-1">
              <div className="relative flex flex-col sm:flex-row items-stretch sm:items-center gap-2.5 z-10">
                ...
                >
                  ...
                  >
                    <div className="flex items-center gap-1.5 text-xs sm:text-sm font-black">
                      <Building2 className="w-4 h-4 group-hover:translate-x-1 group-hover:-translate-y-0.5 transition-transform duration-300" />
                      <span>List Your Space</span>
                    </div>
                    <span className="text-[9px] sm:text-[10px] font-bold uppercase tracking-wider opacity-80 mt-0.5">
                ...
                <button
                  ...
                  className="animate-cta-btn-2 flex-1 relative overflow-hidden inline-flex flex-col items-center justify-center gap-0.5 rounded-xl border-2 border-[#6B0F1A] bg-[#6B0F1A] px-4 py-2 sm:py-2.5 text-[#FFF6A3] shadow-sm transition-all duration-300 ease-[cubic-bezier(0.22,1,0.36,1)] hover:-translate-y-0.5 hover:scale-[1.015] hover:shadow-md active:scale-[0.97] focus:outline-none cursor-pointer group"
                >
                  ...
                  >
                    <div className="flex items-center gap-1.5 text-xs sm:text-sm font-black">
                      <Store className="w-4 h-4 text-[#FFF6A3] group-hover:translate-x-1 group-hover:-translate-y-0.5 transition-transform duration-300" />
          ...
          <div className="lg:col-span-6 relative mt-3 lg:mt-0">
            <div className="relative mx-auto">
              <div className="animate-hero-video-entrance rounded-xl sm:rounded-2xl border-2 border-[#F0E2E4] bg-white p-1 shadow-[0_16px_40px_rgba(11,30,54,0.1)] relative overflow-hidden transition-all duration-350 hover:scale-[1.015] hover:shadow-[0_20px_50px_rgba(11,30,54,0.15)] hover:border-[#F4E409]/60 group">
