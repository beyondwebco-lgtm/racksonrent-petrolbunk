        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-5 lg:gap-6 items-center">
          ...
          <div className="lg:col-span-6 space-y-2.5 sm:space-y-3 relative z-10">
            ...
            <h1 className="font-archivo text-xl sm:text-2xl lg:text-3xl xl:text-4xl font-black tracking-tight text-[#3D0710] leading-[1.08]">
              ...
              <span className="bg-[#FDFF00] text-[#3D0710] px-2 py-0.5 rounded-lg inline-block mt-0.5 border border-[#E6D900]">
            ...
            <div className="relative pt-1">
              <div className="relative flex flex-col sm:flex-row items-stretch sm:items-center gap-2.5 z-10">
                ...
                <button
                  ...
                  className="animate-cta-btn-1 flex-1 relative overflow-hidden inline-flex flex-col items-center justify-center gap-0.5 rounded-xl bg-[#FDFF00] border-2 border-[#E6D900] px-4 py-2 sm:py-2.5 text-[#3D0710] shadow-sm transition-all duration-300 hover:-translate-y-0.5 hover:bg-[#F2E500] hover:shadow-md active:scale-[0.97] focus:outline-none cursor-pointer group"
                >
                ...
                >
                  <div className="absolute inset-0 -translate-x-full group-hover:translate-x-full transition-transform duration-700 ease-in-out bg-gradient-to-r from-transparent via-[#FDFF00]/20 to-transparent pointer-events-none" />
                  <div
                    style={{ transform: `translate(${btn2Pos.x}px, ${btn2Pos.y}px)` }}
                    className="transition-transform duration-200 ease-out flex flex-col items-center justify-center w-full"
                  >
                    <div className="flex items-center gap-1.5 text-xs sm:text-sm font-black">
                      <Store className="w-4 h-4 text-[#FDFF00] group-hover:translate-x-0.5 group-hover:-translate-y-0.5 transition-transform duration-300" />
                      <span>Showcase Your Brand</span>
                    </div>
                    <span className="text-[9px] sm:text-[10px] font-bold uppercase tracking-wider text-[#FDFF00] mt-0.5">
          ...
          <div className="lg:col-span-6 relative mt-3 lg:mt-0">
            <div className="relative mx-auto">
              <div className="animate-hero-video-entrance rounded-xl sm:rounded-2xl border-2 border-[#F0E2E4] bg-[#FFFDF5] p-1 shadow-[0_16px_40px_rgba(61,7,16,0.1)] relative overflow-hidden transition-all duration-350 hover:scale-[1.015] hover:shadow-[0_20px_50px_rgba(61,7,16,0.15)] hover:border-[#FDFF00]/50 group">
                <div className="relative aspect-video max-h-[300px] sm:max-h-[340px] lg:max-h-[350px] w-full rounded-lg sm:rounded-xl overflow-hidden bg-[#FFFBCC]/30">
                  ...
                  <div className="absolute bottom-3 right-3 bg-[#3D0710] text-white px-3 py-1 rounded-full border border-[#FDFF00] shadow-md flex items-center gap-1.5 text-[11px] font-bold tracking-wide z-10">
                    <span className="w-1.5 h-1.5 rounded-full bg-[#FDFF00] animate-ping" />
