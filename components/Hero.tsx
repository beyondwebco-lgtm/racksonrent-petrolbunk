...
export default function Hero({ onSelectRole }: HeroProps) {
  ...
  return (
    <section className="relative pt-8 pb-12 lg:pt-16 lg:pb-20 bg-[radial-gradient(circle_at_80%_20%,rgba(11,30,54,0.06),transparent_40%),linear-gradient(180deg,#FFFDF5_0%,#FFF6A3_50%,#FFFDF5_100%)] border-b border-[#F0E2E4]" id="hero">
          ...
          <div className="lg:col-span-6 space-y-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5 pt-2">
              {benefitItems.map((item, idx) => (
                <div key={idx} className="flex items-center gap-2.5 bg-white p-2.5 rounded-xl border border-[#F0E2E4] shadow-2xs">
